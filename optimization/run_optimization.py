...
def choose_optimizer(opt):
    ...
    if opt == 'smoothed':
        return lambda model, k, seed: gradient_opt(model, k,seed,  neigh=False, min_var=True, use_smoothed=True, use_penalty=False, batch_size=1, steps=400, lr=0.01)
...
if __name__ == "__main__":
    ...
    optimize("smoothed_linear_faster_beta", model_config["model_name"], model, "smoothed", kappas, seed)
